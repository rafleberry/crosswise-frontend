...
import repayAbi from 'config/abi/repay.json'
...
export const getChainLinkContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(ChainLinkAbi, getChainLinkAddress(), signer)
}
...
export const getRepayContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(repayAbi, getRepayAddress(), signer)
}
