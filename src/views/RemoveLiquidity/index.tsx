...
import { Currency, currencyEquals, ETHER, Percent } from '@crosswise/sdk'
...
import { BorderCard, Wrapper, OutlinedButton, ResponsiveFlex } from './styled'
...
export default function RemoveLiquidity({
  ...
  const [approval, approveCallback] = useApproveCallback(parsedAmounts[Field.LIQUIDITY], MAKER_ADDRESS[chainId])
  ...
  async function onRemove() {
    ...
    if (indexOfSuccessfulEstimation === -1) {
      ...
      toastError('This transaction would fail. Please contact support.')
    } else {
              ...
              <LightGreyCard>
                <Flex justifyContent="space-between" mb="8px">
                  <Flex>
                    ...
                    <Text small id="remove-liquidity-tokena-symbol">
                      {currencyA?.symbol}
                    </Text>
                  </Flex>
                ...
                <Flex justifyContent="space-between">
                  <Flex>
                    ...
                    <Text small id="remove-liquidity-tokenb-symbol">
                      {currencyB?.symbol}
                    </Text>
                  </Flex>
                ...
                {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                  <RowBetween style={{ justifyContent: 'flex-end', fontSize: '14px' }}>
                    {oneCurrencyIsETH ? (
                      <StyledInternalLink
                        to={`/liquidity/remove/${currencyA === ETHER ? WBNB[chainId].address : currencyIdA}/${
