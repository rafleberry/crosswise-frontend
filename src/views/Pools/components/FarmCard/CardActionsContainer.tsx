...
import useStakeFarms from 'views/Pools/hooks/useStakeFarms'
import useUnstakeFarms from 'views/Pools/hooks/useUnstakeFarms'
import useApproveFarm from '../../hooks/useApproveFarm'
import { Action, ActionWrapper, OptionContainer, ToggleWrapper, ToggleNameText, StyledActionButton } from './styled'
