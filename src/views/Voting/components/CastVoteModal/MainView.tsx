...
import { IconButton, Text, Skeleton, Button, AutoRenewIcon, ChevronRightIcon, Box, BoxProps } from '@crosswise/uikit'
import BigNumber from 'bignumber.js'
import { useTranslation } from 'contexts/Localization'
import TextEllipsis from '../TextEllipsis'
import { VotingBox } from './styled'
import { CastVoteModalProps } from './types'

const ModalInner: React.FC<BoxProps> = (props) => {
