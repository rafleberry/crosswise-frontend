...
const BasicChart = () => {
  ...
  const [, setPriceHover] = React.useState<number | undefined>()
  const [, setPriceDateHover] = React.useState<string | undefined>()
        ...
        <Flex alignItems="center">
          <TokenPairWrapper>
            <TokenPairImage
              ...
              secondarySrc={`/images/tokens/${tokens.busd.address[chainId]}.svg`}
              height={26}
              width={26}
            />
          </TokenPairWrapper>
