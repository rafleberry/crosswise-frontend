...
import { StyledDivider, StyledCard, StyledCardBody, AddIconBox, StyledCenterBox, StyledHeader } from './styled'
...
export default function AddLiquidity({
  ...
  return (
    <StyledCard>
      ...
      <StyledHeader>{t('Add Liquidity')}</StyledHeader>
      {/* <></> */}
      {/* </TabMenu> */}
                  ...
                  <RowBetween>
                    {approvalA !== ApprovalState.APPROVED && (
                      <Button
                        ...
                        disabled={approvalA === ApprovalState.PENDING || attemptingTxn}
                        // endIcon={attemptingTxn && <AutoRenewIcon spin color="currentColor" />}
                    ...
                    {approvalB !== ApprovalState.APPROVED && (
                      <Button
                        ...
                        disabled={approvalB === ApprovalState.PENDING || attemptingTxn}
                        // endIcon={attemptingTxn && <AutoRenewIcon spin color="currentColor" />}
